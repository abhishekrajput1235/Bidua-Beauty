...
const JoinBrppPage = () => {
  ...
  const { loading: authLoading, error: authError, token } = useAuthStore();
  const {
    createProfile,
    loading,
    error,
  ...
  // ✅ Fetch user's existing profile on mount
  useEffect(() => {
  ...
  const handleSubscribe = () => {
    if (isSubscribed) return; // prevent duplicate
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black px-4 py-16 relative">
      ...
      <div className="container mx-auto max-w-4xl relative z-10">
        ...
        {showProfileForm && (
          <div className="mt-12">
            <BusinessProfileForm onSubmit={handleSubmit} onPaymentSubmit={function (paymentData: any): void {
