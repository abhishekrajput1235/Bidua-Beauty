...
const CheckoutPage = () => {
  ...
  const { cart, fetchCart, checkout, loading: cartLoading, error } = useCartStore();
  const { user } = useAuthStore(); // optional if user info is stored here
          ...
          <div className="space-y-6 lg:space-y-8">
            <div className="bg-gradient-to-br from-gray-800/50 to-black/50 backdrop-blur-sm border border-gray-700/50 rounded-2xl lg:rounded-3xl p-4 sm:p-6 lg:p-8">
              ...
              <div className="space-y-3 lg:space-y-4 mb-4 lg:mb-6">
                {cart.map((item) => (
                  <div key={item.productId} className="flex items-center space-x-3 p-3 lg:p-4 bg-black/30 rounded-xl lg:rounded-2xl">
