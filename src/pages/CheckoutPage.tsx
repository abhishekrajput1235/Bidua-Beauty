...
//   const getShippingCost = (userType, selectedWarehouse, cart) => {
//   // If user is B2B and warehouse is selected, shipping cost = 0
//   if (userType === "b2b" && selectedWarehouse) {
//     return 0;
//   }

//   // Otherwise calculate based on cart items
//   return cart.reduce(
...
const CheckoutPage: React.FC = () => {
  ...
  // Shipping: if user is B2B and they've selected warehouse delivery, shipping = 0
  const getShippingCost = () => {
    if (isB2B && deliveryOption === 'warehouse') return 0;
    return cart.reduce((sum, item) => sum + (item.shippingCharge || 0) * item.quantity, 0);
  };
