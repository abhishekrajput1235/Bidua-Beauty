      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          <div className="space-y-8 bg-gradient-to-br from-gray-800/50 to-black/50 backdrop-blur-sm border border-gray-700/50 rounded-3xl p-8">
            ...
            {currentStep === 2 && <PaymentStep t={t} onBack={() => setCurrentStep(1)} handlePlaceOrder={handlePlaceOrder} isProcessing={isPlacingOrder || cartLoading} cartLoading={cartLoading} />}
          </div>
