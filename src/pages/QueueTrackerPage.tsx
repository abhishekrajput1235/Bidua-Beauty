...
//     );
//   }, [orders]);
//   // place this helper near the top of your component (inside QueueTrackerPage)
// function getUnitForSerial(product, serial) {
//   // product.units is the array you posted in sample
...
//                         {/* ⭐ UPDATED PREMIUM SERIAL CHIP ROW ⭐ */}
//                         <div className="mt-2">
...
//                               <span
//                                 key={serial}
//                                 className="min-w-[170px] px-3 py-1 bg-[#0F111A] border border-amber-500/40 rounded-lg text-amber-300 text-xs font-mono flex items-center justify-center whitespace-nowrap shadow-sm"
//                               >
//                                 {serial} 
