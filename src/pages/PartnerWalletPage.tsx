...
//       getWalletTransactions();
//     }
//   }, [isLoggedIn, getWallet, getWalletTransactions]);

//   const availableBalance = wallet?.balance || 0;
//   const totalRealized = transactions
//     .filter((t) => t.type === "credit")
//     .reduce((acc, t) => acc + t.amount, 0);
//   const escrowPending = transactions
//     .filter((t) => t.status === "pending")
//     .reduce((acc, t) => acc + t.amount, 0);

//   const realizations = transactions;
...
//                   {realizations.map((transaction) => (
//                     <tr key={transaction._id}>
//                       <td className="px-3 sm:px-4 py-3 whitespace-nowrap text-gray-200">
//                         {transaction.description}
//                       </td>
//                       <td className={`px-3 sm:px-4 py-3 text-${transaction.type === 'credit' ? 'green' : 'red'}-400`}>
