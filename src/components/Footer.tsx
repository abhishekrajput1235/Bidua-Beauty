        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="sm:col-span-2 lg:col-span-2 text-center sm:text-left">
            <div className="text-2xl sm:text-3xl font-bold mb-4">
              {t('footer.brand.name')} <span className="gradient-text">{t('footer.brand.suffix')}</span>
            </div>
          ...
          <div className="text-center sm:text-left">
            <h3 className="text-lg sm:text-xl font-bold mb-4 gradient-text">{t('footer.quickLinks.title')}</h3>
            <ul className="space-y-3">
              {t('footer.quickLinks.links', { returnObjects: true }).map((link, idx) => (
          ...
          {/* Contact Info */}
          <div className="text-center sm:text-left">
            <h3 className="text-lg sm:text-xl font-bold mb-4 gradient-text">{t('footer.contact.title')}</h3>
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-center sm:justify-start space-x-3 text-gray-400 hover:text-amber-400 transition-colors duration-300">
                {/* <MapPin size={0} /> */}
                <button
                  onClick={() => window.open(t('footer.contact.address.mapUrl'), '_blank')}
