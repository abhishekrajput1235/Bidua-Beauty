          ...
          >
            ...
            <div className="p-6 flex flex-col">
              ...
              <div className="mt-6 flex items-center gap-3">
                ...
                >
                  <button
                    onClick={() => !isOutOfStock && setQty((q) => Math.max(1, q - 1))}
                    className="px-3 py-2"
                  ...
                  <button
                    onClick={() => !isOutOfStock && setQty((q) => Math.min(q + 1, availableUnits))}
                    className="px-3 py-2"
                ...
                <button
                  ...
                  disabled={isOutOfStock}
                  className={`flex-1 inline-flex items-center justify-center gap-2 px-4 py-2 rounded-lg font-medium transition ${
                    isOutOfStock
